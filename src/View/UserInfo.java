...
public class UserInfo extends JPanel {
	...
	public UserInfo() {
		...
		lblOnlineDot.setIcon(new ImageIcon("src/View//Images/Green.png"));
		if (active) {
			lblOnlineDot.setIcon(new ImageIcon("src/View//Images/Red.png"));
		} else {
			lblOnlineDot.setIcon(new ImageIcon("src/View//Images/Green.png"));
    	}
		...
		add(lblOnlineDot);
				...
				add(lblUserInfo);
						...
						lblBackground.setIcon(new ImageIcon("src/View//Images/MetalBackground.jpg"));
